...
namespace UniversityAPI.Helpers
{
    ...
    {
        /// <summary>
        /// Projects given collection of object to new collection of objects with selected properies only. Return new collection of 'shaped' objects.
        /// </summary>
        /// <typeparam name="TSource"></typeparam>
        /// <param name="source">Source object</param>
        /// <param name="properties">Comma delimiters string of properties names to inculde in returned collection.</param>
        /// <returns></returns>
        public static IEnumerable<ExpandoObject> ShapeData<TSource>( this IEnumerable<TSource> source, string properties)
        {
            ...
            else
            {
                ...
                var fieldsAfterSplit = properties.Split(',');
